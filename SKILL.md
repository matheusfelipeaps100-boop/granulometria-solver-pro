...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `affaan-m-everything-claude-code-coding-standards`                                |
| Version    | 1.0.13                                     |
| Author     | affaan-m                                 |
...
**GitHub:** [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) — ⭐ 106212 | Forks: 13781
...
This Skill defines universal coding standards and best practices for TypeScript, JavaScript, React, and Node.js projects. Use it when starting a new project or module, conducting code reviews, refactoring for maintainability, onboarding contributors, or configuring linting, formatting, and type checking. Key features include readability-first rules (clear variable and function names, consistent formatting), KISS and YAGNI principles to avoid over-engineering, and DRY patterns to centralize reusable logic. It prescribes concrete conventions such as verb-noun function names, descriptive variable names, and immutability patterns (use spread for objects/arrays, avoid in-place mutation). Core advantages are improved maintainability, fewer defects, faster onboarding, and more consistent codebases through enforced naming, structure, and tooling guidance.
...
```bash
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards
```
...
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install affaan-m-everything-claude-code-coding-standards --version 1.0.13
```
...
```bash
npx -y @lobehub/market-cli skills rate affaan-m-everything-claude-code-coding-standards --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment affaan-m-everything-claude-code-coding-standards -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment affaan-m-everything-claude-code-coding-standards
```
...
```bash
npx -y @lobehub/market-cli skills comments affaan-m-everything-claude-code-coding-standards
```
